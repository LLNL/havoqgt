...
int main(int argc, char** argv) {
  ...
  std::string metadata_output_filename = std::string( argv[2] );
  std::string backup_filename = std::string( argv[3] );
  std::string backup_metadata_filename = std::string( argv[4] );
