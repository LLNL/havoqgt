...
template<typename MetaDataType, typename VertexType, typename EdgeIteratorType, typename RandomEdgeContainer>
std::unordered_set< VertexType, typename VertexType::hasher> simple_random_walker<MetaDataType, VertexType, EdgeIteratorType, RandomEdgeContainer>::local_targets;

template<typename MetaDataType, typename VertexType, typename EdgeIteratorType, typename RandomEdgeContainer>
uint64_t simple_random_walker<MetaDataType, VertexType, EdgeIteratorType, RandomEdgeContainer>::max_steps;

template<typename MetaDataType, typename VertexType, typename EdgeIteratorType, typename RandomEdgeContainer>
RandomEdgeContainer *simple_random_walker<MetaDataType, VertexType, EdgeIteratorType, RandomEdgeContainer>::random_edge_container;


template<typename MetaDataType, typename VertexType, typename EdgeIteratorType, typename RandomEdgeContainer>
uint64_t simple_random_walker<MetaDataType, VertexType, EdgeIteratorType, RandomEdgeContainer>::max_attempts = 10;

template<typename MetaDataType, typename VertexType, typename EdgeIteratorType, typename RandomEdgeContainer>
uint32_t simple_random_walker<MetaDataType, VertexType, EdgeIteratorType, RandomEdgeContainer>::prob_restart = 1;
